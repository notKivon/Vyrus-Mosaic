...
**Current step:** 10 — How it works + products
**Next step:** 11 — Compliance, quote, CTA, 404, polish
**Last verified healthy:** 2026-09-24 HKT, step 9 (Mosaic hero + proof row at 360/768/1280, keyboard through nav and dialog, console clean)
...
- Mosaic nav anchors (#audience, #civic, #compliance), "How it works" (#how) and the no-JS briefing fallback (#briefing) point at sections built in steps 10 and 11.
