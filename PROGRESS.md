...
- 2026-09-24 HKT — Product fact extended at Kevin's request: the camera records faces, including other people's in view. CLAUDE.md and the hub brief updated first; the hub's feature table and money-flow step now say so. The Vyrus and Mosaic sites are unchanged (they never state the plain truth).
