...
1. **Header.** Text mark "The Useless Product Launch" and anchor links: Companies, Names, Campaign, Ethics, Making of.
...
3a. **What's in a name.** Two columns, each headed by the name in its brand's type. Vyrus: said aloud it is a virus (caught, spread, lives off its host); written down it mocks big tech naming (a respelled ordinary word, a trendy "y", lowercase with a terminal underscore). Mosaic: the mosaic theory of surveillance in US law (single observations reveal little, together they reveal a life; a 2010 appeals ruling on GPS tracking, five justices in 2012, the 2018 ruling on phone-location records), then the gap Mosaic is built on: the theory limits what government collects itself, not what companies collect and sell, and agencies have bought such data without a warrant. Name courts and years, never parties or judges (no real people). End with a small "not legal advice" line.
